...
namespace Antennas
{
    ...
    public class AntennaItem : Antenna
    {
        ...
        private const double pi_c = Consts.pi2 / Consts.SpeedOfLigth;
        ...
        public SpaceAngle Direction
        {
            ...
            set
            {
                ...
                f_Direction = value;
                f_Rotator = value.Thetta.Equals(0d) && value.Phi.Equals(0d)
                    ? null
                    : value.GetRotator_PhiThetta();
                OnPropertyChanged();
            }
        }

        public double Thetta { get => f_Direction.InRad.Thetta; set => Direction = new SpaceAngle(value, Phi); }

        public double ThettaDeg { get => Thetta / c_ToRad; set => Thetta = value * c_ToRad; }

        public double Phi { get => f_Direction.InRad.Phi; set => Direction = new SpaceAngle(Thetta, value); }
        ...
        public AntennaItem(Antenna a, Vector3D r, SpaceAngle angle, Complex k)
        {
            ...
            PropertyDependence_Add(nameof(Direction), nameof(Thetta), nameof(ThettaDeg), nameof(Phi), nameof(PhiDeg));
        ...
        public override Expression GetPatternExpressionBody(Expression a, Expression f)
        {
            ...
            var kl = (-pi_c).ToExpression().Multiply(f);
        ...
        private void ContractInvariantMethod() => Contract.Invariant(Element != null);
