...
namespace Antennas
{
    public static class BeamPatternExtensions
    {
        ...
        {
            private readonly FuncExtensions.SamplingResult<Complex>.Result[] f_Samples;
            ...
            public (double, Complex) Maximum => f_Samples[MaximumIndex];
            ...
            public (double, Complex) LeftSideLobe => f_Samples[f_LeftSllIndex];
            public (double, Complex) RightSideLobe => f_Samples[f_RightSllIndex];
        ...
        public static double GetDirectivity([NotNull] this Func<double, Complex> F)
        {
            ...
            var I = FuncExtensions.GetIntegralValue_Adaptive(th => f(th).Power * Math.Cos(th), -Consts.pi, Consts.pi);
            return 2 / I;
        }
